...
public class VRequest extends LocalVolleyRequest {
    ...
    public static final String serverIP = "192.168.1.17";
//    public static final String serverIP = "192.168.120.220";
    ...
    public static final String startCameraURLString ="http://" + serverIP + ":5000/start?ip=%s&id=%s&phoneNumber=%s&username=%s&password=%s";
